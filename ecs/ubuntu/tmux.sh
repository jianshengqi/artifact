...
tmux='https://github.com/tmux/tmux/releases/download/3.1c/tmux-3.2.tar.gz'
...
set-window-option -g clock-mode-colour colour135           # 显示颜色
set-window-option -g mode-style nobold                     # 缺省不加粗
set-window-option -g mode-style fg=colour196,bg=colour238  # 缺省色彩
...
# 窗格边框
set-option -g pane-border-style fg=colour238,bg=default        # 设置边界颜色（bg背景颜色， fg为线条颜色）
...
set-window-option -g window-status-current-style fg=colour81,bg=colour238,nobold                                                                                      # 操作状态栏时的缺省色彩
